            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12 mb-3">
                <div class="bg-white border shadow">
                        <div class="media p-4">
                            ...
                            <div class="media-body pl-2">
                                <!-- $spquery = "SELECT COUNT(sp_id) AS num_sp FROM sp";: This line defines a SQL query that counts the number of service provider IDs (sp_id) in the sp table and names this count num_sp -->
                                 <!-- $spqueryresult = mysqli_query($conn, $spquery);: This line executes the SQL query and stores the result in $spqueryresult. mysqli_query is a function that sends the SQL query to the database. -->
                                <?php
